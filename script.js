...
airports.hpn = { name: "White Plains", coords: {lat: 41.0669, lng: -73.7075} };
...
airports.msn = { name: "Madison", coords: {lat: 43.1397, lng: -89.3375} };
airports.bna = { name: "Nashville", coords: {lat: 36.1266, lng: -86.6819} };
